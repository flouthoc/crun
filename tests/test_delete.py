...
def test_simple_delete():
    ...
    try:
        ...
        #    subprocess.check_output(["mkdir", "-p", "/sys/fs/cgroup/freezer/frozen/"], close_fds=False).decode()
        #    subprocess.check_output(["echo", str(state['pid']), ">", "/sys/fs/cgroup/freezer/frozen/tasks"], close_fds=False).decode()
        #    subprocess.check_output(["echo", "FROZEN", ">", "/sys/fs/cgroup/freezer/frozen/freezer.state"], close_fds=False).decode()
